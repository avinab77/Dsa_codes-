//problem to solve sum of k-mirror numbers.
//Leetcode 2081) code in C++ (hard marked)
//daily problem 23/06/2025
...
//T.C = O(10^D/2 * D) (D=log10n)
//S.C = O(D) both are approximations.....
